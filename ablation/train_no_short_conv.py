...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Ablation: disable short convolution in the optimized Hybrid Delta-Attention encoder."
    )
    add_data_arguments(parser, default_output_dir=PROJECT_ROOT / "runs" / "ablation_no_short_conv")
    ...
    parser.set_defaults(
        ...
        experiment_name="no_short_conv",
        reference_experiment="main_hybrid_delta_attention",
        experiment_description="Keep the hybrid topology, attention pooling, and conditional fusion, but remove the local byte-level short convolution.",
        ablation_factors=(
            "delta_short_conv_kernel_size: 4 -> 0",
        ...
        delta_heads=4,
        delta_ffn_dim=512,
        delta_short_conv_kernel_size=0,
